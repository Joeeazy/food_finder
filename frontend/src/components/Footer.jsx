export default function Footer() {
  return (
    <div className="flex-row bg-slate-50 text-black md:justify-between font-semibold ml-10">
      {/* div one */}
      <div className="mb-3">
        <footer className="footer  xl:p-10 py-10 text-center text-1xl px-20 h-[300px] mt-20  ">
          <nav>
          ...
          <form>
            <h6 className="footer-title text-green font-semibold">
            ...
            <fieldset className="form-control w-80">
              ...
              <div className="join text-white">
                <input
                  ...
                  className="input bg-gradient-to-r mr-2 from-green to-lime-300 placeholder-white"
                />
      ...
      {/* div two */}
      <div>
        <footer className="footer p-10 md:space-x-5">
          <aside>
            <img src="/logo.png" />
            <p>
              Your Top Vegeterian Restaurant
              <br />
